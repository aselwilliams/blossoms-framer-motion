...
function Blog() {
  ...
  const blogsData = [
    ...
    },
    {
      ...
      type: "Yoga",
      description:
        "Keep your body and mind it pure and clean for the soul to reside in. Our Spa offers yoga classes in places where relaxation and serenity comes together.",
    },
  ];
  return (
        ...
        {blogsData.map(({ image, title, type, description }) => {
          return (
            <motion.div
              ...
              animate={controls}
              transition={{ delay: 0.03, type: "tween", duration: 0.9 }}
            >
              <div className="image">
